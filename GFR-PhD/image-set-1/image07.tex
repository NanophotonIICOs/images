...
\begin{tikzpicture}
  ...
  child[concept color=blue,font=\fontsize{13}{5}\selectfont] {
    node[concept] {Eléctricas}
    [clockwise from=30]
    child { node[concept] {Movilidad eléctrica del grafeno es del orden de 10$\times10^3 cm^2/V s$} }
    child { node[concept] {Se puede cambiar el Nivel de Fermi con dopaje } }
  }
  child[concept color=purple,font=\fontsize{13}{5}\selectfont] {
    node[concept] {Ópticas}
    [clockwise from=-30]
    child { node[concept] { $\phi \alpha \sim 2.3 \%$} }
    child { node[concept] {Absorbe $2.3\%$ de la luz blanca } }
  }
  child[concept color=red,font=\fontsize{13}{5}\selectfont] { 
    node[concept] {Mecánicas} 
    [clockwise from=-48]
    child { node[concept] {Material mas fuerte encontrado} }
    child { node[concept] {Material muy ligero} }
  }
  ;
