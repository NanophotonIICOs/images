...
\addplot[thick,white] graphics[xmin=0,ymin=0,xmax=511,ymax=511] {data/image-1slmpp-a1-ras.pdf};
...
\foreach \x in {1,...,4}{
\addplot+[mark=none,smooth] table[col sep=comma,x index=0,y index=\x] {data/lines-1slmpp-p1-ras.txt};
}

        %\draw(axis cs:2.15,-0.007) rectangle (axis cs:2.5,0.012);

        \coordinate (r1) at (axis cs:4.5,-2e-4);
        \coordinate (r2) at (axis cs:4.25,2e-4);
