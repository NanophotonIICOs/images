...
\addplot[thick,white] graphics[xmin=0,ymin=0,xmax=511,ymax=511] {data/image-2slmpp-a2-r.pdf};
...
\foreach \x in {1,...,4}{
\addplot+[mark=none,smooth] table[col sep=comma,x index=0,y index=\x] {data/lines-2slmpp-p2-r.txt};
}
...
\addplot[thick,white,opacity=0.9] graphics[xmin=0,ymin=0,xmax=\xpix,ymax=\ypix] {data/image-2slmpp-b2-r.pdf};
