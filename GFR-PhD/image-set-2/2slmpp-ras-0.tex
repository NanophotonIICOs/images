...
\begin{document}
    \begin{tikzpicture}
        \begin{groupplot}[group style={
			...
			\addplot[thick,white] graphics[xmin=0,ymin=0,xmax=511,ymax=511] {gnuplot-out/image-2slmpp-a1-ras.pdf};
...
\coordinate (c1) at (\xi+\xf,\yi+\yf);
		...
		\begin{axis}[view={0}{90},
			...
			\addplot[thick,white,opacity=0.9] graphics[xmin=0,ymin=0,xmax=\xpix,ymax=\ypix] {gnuplot-out/image-2slmpp-b1-ras.pdf};
