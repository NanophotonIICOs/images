...
\pgfplotstableread[col sep=comma]{/media/labfiles/Gabriela-FR/Experimentos/PCdte/CdZnTe/RD_CdZnTe.dat}{\rd}
...
\addlegendentry{CdZnTe RAS}

\def\sc{1}
\lbl{3.2}{3e-3}{2.25e-3}{$E_{1}$}{3}{\sc}{Set1-B}

\lbl{4.0}{1.4e-3}{2e-3}{$E_{1}+\Delta_{1}$}{-2}{\sc}{Set1-B}
