...
\pgfplotstableread[col sep=comma]{/media/labfiles/Gabriela-FR/Experimentos/PCdte/HgCdTe/RD_HgCdTe.dat}{\rd}
...
\addlegendentry{HgCdTe RAS}

\def\sc{0.8}
\lbl{3.2}{2e-3}{3e-3}{$E_{1}$}{3}{\sc}{black}

\lbl{4.0}{0e-3}{1e-3}{$E_{1}+\Delta_{1}$}{-2}{\sc}{black}
